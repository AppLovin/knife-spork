  ...
  module Runner
    ...
    module InstanceMethods
      def spork_config
        ...
        load_paths = [ File.expand_path("~/.spork-config.yml"), File.expand_path("#{cookbook_path.gsub('cookbooks','')}/config/spork-config.yml"), File.expand_path('config/spork-config.yml'), '/etc/spork-config.yml', File.expand_path('~/.chef/spork-config.yml') ]
